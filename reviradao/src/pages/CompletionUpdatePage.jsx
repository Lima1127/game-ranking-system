  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      <div>
        ...
        <h1 className="mt-2 text-4xl font-black text-slate-900">Atualizar Registro</h1>
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        <div className="text-sm text-slate-500">Jogo</div>
        <div className="text-2xl font-black text-slate-900">{completion.gameName}</div>
      </div>

      <form onSubmit={handleSubmit} className="rounded-2xl bg-white p-8 shadow-sm space-y-6">
        <div className="grid gap-6 md:grid-cols-2">
          <div>
            <label className="mb-2 block font-bold text-slate-700">Data de Conclusao</label>
            <input
              type="date"
              name="completedAt"
          ...
          <div>
            <label className="mb-2 block font-bold text-slate-700">Horas Jogadas</label>
            <input
              type="number"
              name="hoursPlayed"
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <label className="flex items-center rounded-lg border border-slate-300 p-4">
            <input type="checkbox" name="firstTimeEver" checked={form.firstTimeEver} onChange={handleChange} className="h-5 w-5" />
            <span className="ml-3 font-semibold text-slate-700">Primeira Experiencia</span>
          </label>
          ...
          <label className="flex items-center rounded-lg border border-slate-300 p-4">
            ...
            <span className="ml-3 font-semibold text-slate-700">Em Dia</span>
          </label>

          <label className="flex items-center rounded-lg border border-slate-300 p-4 md:col-span-2">
            <input type="checkbox" name="platinum" checked={form.platinum} onChange={handleChange} className="h-5 w-5" />
            <span className="ml-3 font-semibold text-slate-700">Platina (100%)</span>
          </label>
        </div>

        <div>
          <label className="mb-2 block font-bold text-slate-700">Observacoes</label>
          <textarea
            name="notes"
            value={form.notes}
            onChange={handleChange}
        ...
        <div className="rounded-xl border border-amber-200 bg-amber-50 p-5">
          <label className="mb-2 block font-bold text-amber-900">
          ...
          />
          <p className="mt-2 text-sm text-amber-800">Envie uma nova imagem para comprovar a atualizacao, ate {formatFileSize(MAX_IMAGE_SIZE)}.</p>
          {proofFile && (
